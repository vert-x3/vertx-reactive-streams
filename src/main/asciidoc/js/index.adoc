...
We provide an implementation of the Vert.x `ReadStream` interface with `link:jsdoc/reactive_read_stream-ReactiveReadStream.html[ReactiveReadStream]`
...
[source,java]
----
`link:jsdoc/reactive_streams_examples-ReactiveStreamsExamples.html#example1[example1]`
----

== Reactive Write Stream

We also provide an implementation of the Vert.x `WriteStream` interface with `link:jsdoc/reactive_write_stream-ReactiveWriteStream.html[ReactiveWriteStream]`
...
[source,java]
----
`link:jsdoc/reactive_streams_examples-ReactiveStreamsExamples.html#example2[example2]`
----