...
We provide an implementation of the Vert.x `ReadStream` interface with `link:groovydoc/io/vertx/groovy/ext/reactivestreams/ReactiveReadStream.html[ReactiveReadStream]`
...
[source,java]
----
`link:groovydoc/examples/ReactiveStreamsExamples.html#example1(io.vertx.core.http.HttpServerResponse,%20org.reactivestreams.Publisher)[example1]`
----

== Reactive Write Stream

We also provide an implementation of the Vert.x `WriteStream` interface with `link:groovydoc/io/vertx/groovy/ext/reactivestreams/ReactiveWriteStream.html[ReactiveWriteStream]`
...
[source,java]
----
`link:groovydoc/examples/ReactiveStreamsExamples.html#example2(io.vertx.core.Vertx,%20io.vertx.core.http.HttpServerRequest,%20org.reactivestreams.Subscriber)[example2]`
----